...
JK_backpacks = ["O_Mortar_01_support_F"];
...
JK_items = ["ACRE_PRC343","ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_HuntIR_monitor","rhsusf_acc_compm4","ACE_RangeTable_82mm"];
