...
JK_items = ["ACRE_PRC343","ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_ATragMX","ACE_RangeCard","ACE_Kestrel4500","rhsusf_acc_compm4","rhsusf_acc_LEUPOLDMK4_2","ACE_M84","ACE_DAGR"];
