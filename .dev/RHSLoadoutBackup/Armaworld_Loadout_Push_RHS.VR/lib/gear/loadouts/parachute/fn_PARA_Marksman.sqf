...
JK_primaryweapon = "rhs_weap_m14ebrri";

//primary weapon items - (array)
JK_itemsPrimaryweapon = ["optic_DMS","rhsusf_acc_anpeq15side","rhsusf_acc_harris_bipod", ["rhsusf_acc_SFMB556", "rhsusf_acc_SF3P556", ""]];
...
JK_items = ["ACRE_PRC343","ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_ATragMX","ACE_RangeCard","ACE_Kestrel4500","rhsusf_acc_compm4"];
