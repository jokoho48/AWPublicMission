...
JK_primaryweapon = ["hlc_rifle_g3a3ris"];

//primary weapon items - (array)
JK_itemsPrimaryweapon = [["RKSL_optic_PMII_312_sunshade"]];
...
JK_primaryweaponAmmo = "hlc_20rnd_762x51_b_G3";
JK_primaryweaponAmmoCount = 7;
JK_primaryweaponTracers = "hlc_20rnd_762x51_b_G3";
