...
if ((paramsArray select 0) in [1, 3]) then {
    ...
    JK_SPECIALCLASSES = ["SC_PJMEDIC", "SC_PILOT", "SC_JETPILOT", "SC_CREW", "SC_DIVER","SC_CREWCHIEF","SC_DIVER_ARm","SC_DIVER_AT","SC_DIVER_Leader","SC_DIVER_Marksman","SC_DIVER_Specialist"];
