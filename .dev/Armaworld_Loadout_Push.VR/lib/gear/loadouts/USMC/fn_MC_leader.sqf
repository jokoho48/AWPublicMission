...
JK_vests = ["rhsusf_spc_teamleader"];
...
JK_items = ["ACRE_PRC148","ACRE_PRC343","ACE_Flashlight_MX991","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_monitor","ACE_MapTools","ACE_CableTie","ACE_microDAGR","rhsusf_acc_compm4"];
