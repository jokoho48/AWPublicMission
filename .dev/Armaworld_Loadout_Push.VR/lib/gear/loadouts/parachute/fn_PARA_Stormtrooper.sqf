...
JK_itemsVest = ["ACE_Clacker","DemoCharge_Remote_Mag","ACE_DefusalKit"];
...
JK_items = ["ACRE_PRC343","ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_M84"];
