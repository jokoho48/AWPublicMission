...
JK_vests = ["rhsusf_iotv_ocp_Grenadier"];
...
JK_items = ["ACRE_PRC343","ACE_Flashlight_MX991","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_MapTools","ACE_CableTie","ACE_microDAGR","rhsusf_acc_compm4","ACE_M84","ACE_DAGR"];
