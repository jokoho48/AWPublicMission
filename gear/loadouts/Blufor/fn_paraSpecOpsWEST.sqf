...
_headgears = ["H_Bandanna_khk_hs", "rhsusf_opscore_01_tan", "H_HelmetSpecB_paint1", "H_HelmetSpecB_blk", "H_Bandanna_camo", "rhsusf_ach_bare_des_headset_ess", "rhsusf_opscore_02_tan", "H_HelmetSpecB", "H_HelmetSpecB_snakeskin", "H_HelmetSpecB_sand", "rhsusf_lwh_helmet_marpatwd","rhsusf_ach_helmet_headset_ocp"];
...
_itemsPrimaryweapon = [["rhsusf_acc_ACOG2_USMC","rhsusf_acc_ACOG3_USMC","ACE_optic_Hamr_2D"],"rhsusf_acc_anpeq15side","rhsusf_acc_harris_bipod",["rhsusf_acc_nt4_black","rhsusf_acc_rotex5_grey"]];
...
_primaryweaponAmmo = 7;
_primaryweaponTracers = 1;
...
_itemsVest = ["DemoCharge_Remote_Mag","ACE_Clacker","ACE_M84","ACE_M84","ACE_M84","ACE_DefusalKit"];
