...
//Vehicle Array
JK_vvsArray = ["rhs_vehclass_car", "rhs_vehclass_car_wd", "rhs_vehclass_mrap", "rhs_vehclass_mrap_wd", "rhs_vehclass_truck", "rhs_vehclass_truck_wd"];

//clothing - (string)
_uniforms = ["rhs_uniform_cu_ocp"];
_vests = ["rhsusf_iotv_ocp_Squadleader"];
...
_items = ["ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_M203","ACE_HuntIR_monitor","ACE_MapTools","ACE_CableTie","ACE_microDAGR","rhsusf_acc_compm4"];
