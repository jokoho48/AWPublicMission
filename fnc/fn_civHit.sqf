...
if (local _target && {alive _target} && {side _target isEqualTo CIVILIAN} && {isPlayer _shooter} && {!(_shooter getvariable ["ACE_isUnconscious", false])} && {!(_target getVariable ["JK_isBomber", false])}) then {
