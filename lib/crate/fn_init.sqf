...
[{
    if (isNil "JK_postInit" && isNil "VSS" && isNil "ammonition" && isNil "ammonition2" && {isNull VSS && isNull ammonition2 && isNull ammonition}) exitWith {};
    [{
        ...
        [VSS, "<t color='#AE2020'>Open Vehicle Menu</t>", {createDialog "VSS_Menu"}] call JK_Core_fnc_addAction;
