...
JK_items = ["ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","rhsusf_acc_compm4","ACE_DAGR","ACE_Banana","ACE_Vector","ACE_NVG_Wide"];
