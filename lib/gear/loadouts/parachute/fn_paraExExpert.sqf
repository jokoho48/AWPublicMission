...
JK_itemsVest = ["MineDetector","ACE_DefusalKit","ACE_Flashlight_MX991","ACE_MapTools","ACE_CableTie","ACE_microDAGR","rhsusf_acc_compm4","ACE_M26_Clacker","ACE_Clacker","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag"];
