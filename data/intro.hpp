...
class IntroRscShortcutButtonMain
{
    idc = -1;
    style = 0;
    default = 0;
...
class IntroRscButtonMenuCancel
{
    idc = 2;
    shortcuts[] =
    {
...
class Rules_Header: IntroRscText
{
    idc = 1000;
...
class AW_Intro_and_TS_picture: IntroRscPicture
{
    idc = 1200;
    text = "media\Aw_Intro_Image.paa";
    x = 0;
    y = 0;
    w = 1;
    h = 1;
};
class Ok_button: IntroRscButton
{
    idc = 1600;
...
class General_hints: IntroRscFrame
{
    idc = 1801;
    x = -0.713889;
    y = 0.00208756;
...
class Genreal_hints_Header: IntroRscText
{
    idc = 1011;
