...
#define OBJVEH_TYPES "rhs_gaz66_msv","rhs_uaz_XX"
...
//-------------------------------------------------------------------------- CREATE GROUP, VEHICLE AND UNIT
    ...
    "rhs_msv_sergeant" createUnit [_flatPos1, _aGroup];
    ...
    "rhs_msv_sergeant" createUnit [_flatPos1, _bGroup];
    ...
    "rhs_msv_sergeant" createUnit [_flatPos2, _cGroup];
