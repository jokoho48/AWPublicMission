...
//-------------------- SPAWN GUARDS and CIVILIANS
	...
	//[[currentSM],[6,1],[7,1],[0,0],[0],[0],[0,0],[6,0,1200,EAST,false,false]] call EOS_Spawn; //guards
	[["sm13"],[6,1],[7,1],[0,0],[0],[0],[0,0],[6,0,1200,EAST,false,false]] call EOS_Spawn; //guards
	sleep 1;
	[["sm13"],[3,1],[4,1],[0,0],[0],[0],[0,0],[3,1,1100,EAST,false,false]] call EOS_Spawn; //civs
