...
_c4Message = ["Radardaten gesichert. Sprengladung platziert! 30 Sekunden bis zur Detonation.","Radardaten gesichert. C4 wurde platziert! 30 Sekunden bis zur Explosion.","Radardaten gesichert. Die Sprengladungen wurden platziert! 30 Sekunden bis zur Explosion."] call BIS_fnc_selectRandom;
...
//-------------------- FIND SAFE POSITION FOR OBJECTIVE
    ...
    while {!_accepted} do {
        ...
        _flatPos = _position isFlatEmpty [5,0,0.1,sizeOf "rhs_prv13",0,false];
...
//-------------------- SPAWN OBJECTIVE
    ...
    sideObj = "rhs_prv13" createVehicle _flatPos;
...
//-------------------- BRIEF
    ...
    sideMarkerText = "Radar sichern"; publicVariable "sideMarkerText";
    "sideMarker" setMarkerText "Nebenmission: Radar sichern"; publicVariable "sideMarker";
    publicVariable "sideObj";

    _briefing = "<t align='center'><t size='2.2'>Neue Nebenmission</t><br/><t size='1.5' color='#00B2EE'>Radar sichern</t><br/>____________________<br/>Feindkräfte haben eine mobile Radarstation auf der Insel aufgebaut, um ihre Lufteinheiten zu unterstützen.<br/><br/>Wir haben die Position auf der Karte markiert; rückt auf die Position vor und räumt das Gelände. Sichert die Daten und zerstört das Radar!</t>";
    GlobalHint = _briefing; hint parseText _briefing; publicVariable "GlobalHint";
    showNotification = ["NewSideMission", "Radar sichern"]; publicVariable "showNotification";
    sideMarkerText = "Radar sichern"; publicVariable "sideMarkerText";
...
while { sideMissionUp } do {
    ...
    if (!alive sideObj) exitWith {
        ...
        hqSideChat = "Radar vor Datensicherung zerstört! Mission FEHLGESCHLAGEN!"; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
        ...
        deleteVehicle nearestObject [getPos sideObj,"rhs_prv13"];
