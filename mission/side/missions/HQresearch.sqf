...
_c4Message = ["Festplatte gesichert. C4 wurde platziert! 30 Sekunden bis zur Explosion.","Forschungen gesichert. Sprengladungen wurden gesichert! 30 Sekunden bis zur Detonation.","Daten wurden gesichert. Sprengstoff wurde platziert! 30 Sekunden bis zur Explosion."] call BIS_fnc_selectRandom;
#define VEH_TYPE "rhs_tigr_vdv","rhs_uaz_XX","rhs_ural_open_xx","rhs_ural_fuel_xx_01"
...
//-------------------- BRIEF
	...
	sideMarkerText = "Forschungsdaten sicherstellen"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Nebenmission: Forschungsdaten sicherstellen"; publicVariable "sideMarker";
	publicVariable "sideObj";
	
	_briefing = "<t align='center'><t size='2.2'>Neue Nebenmission</t><br/><t size='1.5' color='#00B2EE'>Forschungsdaten sicherstellen</t><br/>____________________<br/>Feindkräfte führen umfangreiche militärische Forschungen auf Altis aus.<br/><br/>Findet die Daten und zerstört die Forschungseinrichtung!</t>";
	GlobalHint = _briefing; publicVariable "GlobalHint"; hint parseText GlobalHint;
	showNotification = ["NewSideMission", "Forschungsdaten sicherstellen"]; publicVariable "showNotification";
...
while { sideMissionUp } do {
	...
	if (!alive sideObj) exitWith {
		...
		hqSideChat = "Ziel zerstört! Mission FEHLGESCHLAGEN!"; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
