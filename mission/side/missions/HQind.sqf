...
_c4Message = ["Prototypen wurden gesichert. Die Sprengladungen wurden gesetzt! 30 Sekunden bis zur Detonation.","Raketenwerfer gesichert. Die Sprengladungen wurden gesetzt! 30 Sekunden bis zur Detonation.","Raketenwerfer gesichert. Die Sprengladungen wurden gesetzt! 30 Sekunden bis zur Detonation."] call BIS_fnc_selectRandom;
...
//-------------------- SPAWN OBJECTIVE
    ...
    truck1 = "rhs_gaz66_msv" createVehicle _flatPos1;
    truck2 = "rhs_gaz66o_msv" createVehicle _flatPos2;
...
//-------------------- SPAWN BRIEFING
    ...
    sideMarkerText = "Raketenwerfer sichern"; publicVariable "sideMarkerText";
    "sideMarker" setMarkerText "Nebenmission: Raketenwerfer sichern"; publicVariable "sideMarker";
    publicVariable "sideObj";
    _briefing = "<t align='center'><t size='2.2'>Neue Nebenmission</t><br/><t size='1.5' color='#00B2EE'>Raketenwerfer sichern</t><br/>____________________<br/>Feindkräfte haben bei einem Überfall auf einen Konvoi eine Kiste mit streng geheimen Raketenwerfern erbeutet.<br/><br/>Intel konnte durch Einsatz von modernster Technik die Waffenkiste orten. Rückt schnell auf die markierte Position vor, bevor sie mit den Prototypen fliehen!</t>";
    GlobalHint = _briefing; hint parseText GlobalHint; publicVariable "GlobalHint";
    showNotification = ["NewSideMission", "Raketenwerfer sichern"]; publicVariable "showNotification";
    sideMarkerText = "Raketenwerfer sichern"; publicVariable "sideMarkerText";
...
while { sideMissionUp } do {
    ...
    if (!alive sideObj) exitWith {
        ...
        hqSideChat = "Prototypen zerstört! Mission FEHLGESCHLAGEN!"; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
