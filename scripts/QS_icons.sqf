...
_QS_fnc_iconColor = {
    ...
    params ["_v", "_display", "_QS_ST_X", "_ms"];
...
_QS_fnc_iconText = {
    private ['_n','_y','_vt','_t','_vn','_isAdmin','_newText','_crewIndex','_crewCount','_crewIndex_indexed','_showMOS','_showAINames','_auv','_na'];
    params ["_v", "_display", "_QS_ST_X", "_ms"];
...
_QS_fnc_iconUnits = {
    private ['_si','_as','_au','_vars','_exit'];
    params ["_di", "_QS_ST_X"];
    _exit = false;
...
_QS_fnc_iconDrawMap = {
    private ['_ve','_it','_co','_po','_is','_di','_te','_sh','_ts','_tf','_to','_au','_QS_ST_X','_ms','_de'];
    params ["_m"];
    _QS_ST_X = [] call QS_ST_X;
    _ms = ctrlMapScale _m;
...
_QS_fnc_iconDrawGPS = {
    private ['_ve','_it','_co','_po','_is','_di','_te','_sh','_ts','_tf','_to','_au','_QS_ST_X','_de'];
    params ['_m'];
    _QS_ST_X = [] call QS_ST_X;
...
_QS_fnc_groupIconText = {
    private ['_text','_getIndex','_element','_counter','_index','_grpIndex'];
...
_QS_fnc_groupIconType = {
    private [
        '_iconType', '_iconTypes_EAST','_iconTypes_WEST','_iconTypes_RESISTANCE','_iconTypes_CIVILIAN','_vType','_iconTypes',
        '_grpVehicle_type'
    ];
...
if (_QS_ST_X select 2) then {
    ...
    [_QS_ST_X] spawn {
        ...
        private [
            '_grp','_grpLeader','_as','_grpIconArray','_grpID','_sidesFriendly','_checkDiplomacy_delay','_checkDiplomacy','_dynamicDiplomacy','_showFriendlySides',
