...
#define OPTICS_MSG "Thermalvisiere sind auf unserem Server nicht erlaubt."
...
_EHFIRED = {
	...
	hintC "Sie feuern ihre Waffe innerhalb der Basis ohne Genehmigung ab. Stellen Sie sofort das Feuer ein!";
