...
if(lnbCurSelRow 38101 isEqualTo -1) exitWith {hintSilent "You did not select a vehicle to spawn!"};
...
if(isNil "_position") exitWith {hintSilent "The spawn position marker doesn't exist?"; player setVariable ["SEN_inProgress",false];};
