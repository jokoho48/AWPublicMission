...
// RHS Russian
	if (_faction==6) then {
	_InfPool=	["rhs_msv_rifleman","rhs_msv_efreitor","rhs_msv_grenadier","rhs_msv_machinegunner","rhs_msv_machinegunner_assistant","rhs_msv_at","rhs_msv_strelok_rpg_assist","rhs_msv_marksman","rhs_msv_officer_armored","rhs_msv_officer","rhs_msv_junior_sergeant","rhs_msv_sergeant","rhs_msv_engineer","rhs_msv_aa","rhs_msv_medic","rhs_msv_LAT"];	
	_ArmPool=	["rhs_sprut_vdv","RHS_BM21_MSV_01", "rhs_bmd1", "rhs_bmd2", "rhs_bmd4_vdv", "rhs_bmp1_XX", "rhs_bmp2e_XX", "rhs_brm1k_msv", "rhs_btr60_msv", "rhs_btr70_msv", "rhs_btr80_msv", "rhs_prp3_msv", "rhs_t72ba_tv", "rhs_t80", "rhs_zsu234_aa"];
	_MotPool=	["rhs_tigr_msv","rhs_gaz66_msv","rhs_typhoon_vdv","rhs_uaz_XX","rhs_ural_XX","rhs_ural_open_XX","RHS_Ural_Fuel_XX_01"];
	_ACHPool=	["RHS_Ka52_vvs","RHS_Mi24P_vdv","RHS_Mi8AMT_vdv","RHS_Mi8mt_vdv","RHS_Su25SM_vvs"];
	_CHPool=	["rhs_ka60_grey"];
	_uavPool=	[];
	_stPool=	["rhs_weap_2p130","rhs_weap_902a"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["rhs_msv_combatcrew","rhs_msv_armoredcrew","rhs_msv_crew_commander","rhs_msv_crew","rhs_msv_driver_armored","rhs_msv_driver"];
	_heliCrew=	[];};
