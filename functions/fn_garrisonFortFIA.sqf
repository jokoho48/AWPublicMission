...
__________________________________________________________________*/
    ...
    private ["_faction", "_coef", "_buildings", "_paramsArray", "_finalCnt", "_newGrp", "_units"];
    params ["_building"];
    _faction = "OPF_F";
    _coef = 1;

    BIS_getRelPos = {
        private ["_relDir", "_dist", "_elev", "_dir"];
    ...
    if (!(typeOf _building in _buildings)) exitWith { objNull };
    ...
    _units = ["rhs_msv_rifleman", "rhs_msv_medic"];
