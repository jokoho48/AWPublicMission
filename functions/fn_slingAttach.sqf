...
private [ "_hType", "_nearUnits", "_liftable", "_hPos", "_hVel", "_closestUnit", "_closestDist", "_unit", "_unitPos", "_unitDist", "_closestUnitType", "_minZ", "_midY", "_attachPoint", "_wasCollide", "_height", "_speedHelo"];
params ["_h"];
