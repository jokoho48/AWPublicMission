...
private ["_dir", "_obstructions", "_obstructionsArray", "_obstructions2Array", "_minDistFromCenter", "_maxDistFromCenter", "_accepted", "_safePos", "_emptyPosition", "_obstructionsDead"];
