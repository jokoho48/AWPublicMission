...
for "_x" from 0 to 2 do {
	...
	_IRGsniperGroup = [_randomPos, EAST, (configfile >> "CfgGroups" >> "East" >> "rhs_faction_msv" >> "rhs_group_rus_msv_Ural" >> "rhs_group_rus_msv_Ural_squad_sniper")] call BIS_fnc_spawnGroup;
