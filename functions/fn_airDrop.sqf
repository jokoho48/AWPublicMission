...
private ["_reloadtime", "_chuteType", "_crateType", "_smokeType", "_lightType", "_minheight", "_chute", "_light", "_smoke"];
...
pvBroadcast = [WEST,"AirBase"] sideChat "UH-80 Supply Drop has been deployed!";
publicVariable "pvBroadcast";
