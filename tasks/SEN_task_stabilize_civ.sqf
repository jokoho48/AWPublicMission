...
_town = selectRandom SEN_whitelistLocation;
...
_civ = (createGroup CIVILIAN) createUnit [selectRandom SEN_unitPoolCiv,_pos, [], 0, "NONE"];
...
if (ace_medical_level isEqualTo 1) then {
    ...
    for "_i" from 0 to ceil random 2 do {
        ...
        [_civ, (selectRandom _part), _damage] call ace_medical_fnc_setHitPointDamage;
    };
